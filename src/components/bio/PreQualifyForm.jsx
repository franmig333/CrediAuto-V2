...
export const PreQualifyForm = () => {
    ...
    const handlePhoneChange = (e) => {
        const currentPhone = formData?.phone || ''; // Safe access
    ...
    const isFormValid = () => {
        ...
        if (safePhone.length !== 10 || !safePhone.startsWith('09')) return false;
        return true;
    };
    ...
    return (
        <div className="bg-brand-800 rounded-t-3xl p-8 border-t border-brand-700 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
            ...
            {!formData ? <div className="text-center text-white">Cargando formulario...</div> : (
                <>
